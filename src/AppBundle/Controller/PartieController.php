...
class PartieController extends Controller
{
    ...
    public function changerTour(Request $request, Partie $partie)
    {
        ...
        if ($tourde == $joueur1) {
            ...
            $score = ((($extraAperitif + 1) * array_sum($tabAperitif)) - 20) + ((($extraEntree + 1) * array_sum($tabEntree)) - 20) + ((($extraPlat + 1) * array_sum($tabPlat)) - 20) + ((($extraLaitage + 1) * array_sum($tabLaitage)) - 20) + ((($extraDessert + 1) * array_sum($tabDessert)) - 20);
